...
export default function AdminDashboard() {
  ...
  // Add urgent notifications state
  ...
  const submitAnswer = async (report, answerText) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/adminanswers/create",
        {
          method: "POST",
          credentials: "include",
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch users
        const usersRes = await fetch("http://localhost:5000/api/auth/all", {
          credentials: "include",
        });
        ...
        const anonRes = await fetch("http://localhost:5000/api/anonymous/all", {
          credentials: "include",
        });
        ...
        // Fetch info reports
        const infoRes = await fetch("http://localhost:5000/api/userinfo/all", {
          credentials: "include",
        });
        ...
        const answersRes = await fetch(
          "http://localhost:5000/api/adminanswers/all",
          {
            credentials: "include",
          }
        );
    ...
    const fetchUrgentNotifications = async () => {
      try {
        ...
        const response = await fetch("http://localhost:5000/api/admin/urgent", {
          credentials: "include",
        });
        if (!response.ok)
  ...
  const resolveNotification = async (id) => {
    try {
      await fetch(`http://localhost:5000/api/admin/urgent/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-red-600">
                      Sentiment score: {notification.sentimentScore.toFixed(2)}
                    </p>
                  </div>
                  <button
